...
${CURL} -v -L ${HOST_HTTP_METAMAN}/${RMTDATADIR}/myfiletorenamemeta -T ${LCLDATADIR}/srv1.ref
${CURL} -v -L ${HOST_HTTP_MAN1}/${RMTDATADIR}/myfiletorenameman -T ${LCLDATADIR}/srv1.ref
${CURL} -v -L ${HOST_HTTP_SRV1}/${RMTDATADIR}/myfiletorenamesrv -T ${LCLDATADIR}/srv1.ref
# check rename
set -x
echo "Renaming from Meta manager / origin .. "
${CURL} -X MOVE -v -L -H "Destination: ${HOST_HTTP_METAMAN}/${RMTDATADIR}/newfilenamemeta" ${HOST_HTTP_METAMAN}/${RMTDATADIR}/myfiletorenamemeta

echo "Renaming from Manager "
${CURL} -X MOVE -v -L -H "Destination: ${HOST_HTTP_MAN1}/${RMTDATADIR}/newfilenameman" ${HOST_HTTP_MAN1}/${RMTDATADIR}/myfiletorenameman

echo "Renaming directly from server "
${CURL} -X MOVE -v -L -H "Destination: ${HOST_HTTP_SRV1}/${RMTDATADIR}/newfilenamesrv" ${HOST_HTTP_SRV1}/${RMTDATADIR}/myfiletorenamesrv
set +x
