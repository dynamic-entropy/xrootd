...
public:
  ...
  // Pointer to monitoring state - forward declared to avoid including XrdHttpMon.hh in header
  // The actual state structure is defined in XrdHttpMon.hh
  // Access monStateHandle->state directly in implementation files that include XrdHttpMon.hh
  XrdHttpMonState *monStateHandle;
